...
import pandas as pd
import re
from PyQt5.QtWidgets import QApplication, QMainWindow, QLabel, QHBoxLayout, QVBoxLayout, QPushButton, QWidget, QLineEdit, QTableWidget, QTableWidgetItem, QHeaderView, QMessageBox
from PyQt5.QtGui import QIcon, QPixmap, QFont

# 读取社工库.xlxs文件
data_frame = pd.read_excel('./src/basic_info.xlsx')
